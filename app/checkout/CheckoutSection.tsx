...
const CheckoutFormRow: NextPage<CheckoutFormRowProps> = ({text, placeholder, type}) => {
  return (
    <div className="flex flex-col p-2 sm:min-w-[40vw] lg:min-w-[0vw]">
      ...
      <input required={true} className="text-[0.7rem] bg-grey-bg opacity-50 px-2 py-[10px] md:py-4 rounded-[8px]"
      ...
      <div className="flex flex-wrap ">
        <div  className="md:min-w-[700px] lg:w-2/3  p-4 lg:px-12">
          ...
          <form className="w-full min-h-[40vh]">
            ...
            <SmallButton type="submit" text="Make Payment" onClick={handlePayment} />
          </form>
        </div>
        <CheckoutCard text="" pageUrl="/checkout" type="button" />
      </div>
    </main>
  )
};
