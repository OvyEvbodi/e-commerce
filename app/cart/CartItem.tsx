...
const CartItem:NextPage<BigCardProps> = ({id, image, title, price, quantity }) => {
  ...
  return (
    <div className="bg-blue-300 py-4 flex flex-wrap items-center justify-between border-t">
      ...
      <div className="bg-blue-200 md:w-3/5 md:text-[1.15rem] md:text-[1.3rem] gap-[12px] md:gap-6 flex flex-wrap justify-evenly items-center p-2">
        <p className="">${price}</p>
