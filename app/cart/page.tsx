  ...
  return (
    <main className="mb-6 lg:mb-16">
      ...
      <div className="flex flex-wrap ">
        <div  className="lg:w-2/3  p-4 lg:px-12">
          <div className="bg-grey-bg rounded-[8px] text-[1.2rem] flex flex-wrap justify-between items-center p-2">
            <h6 className="font-bold">Item</h6>
            <div className="font-bold w-3/5 flex flex-wrap justify-evenly items-center p-2 lg:pr-16">
              <h6>Price</h6>
              <h6>Quantity</h6>
              <h6>Subtotal</h6>
            </div>
